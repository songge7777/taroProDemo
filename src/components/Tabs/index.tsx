...
import { CommonEvent, ITouchEvent, ScrollView, View } from '@tarojs/components';
...
export default class AtTabs extends Component<dTaroUi.AtTabsProps, dTaroUi.AtTabsState> {
  // eslint-disable-next-line react/sort-comp
  public static defaultProps: dTaroUi.AtTabsProps
  public static propTypes: InferProps<dTaroUi.AtTabsProps>
  ...
  public constructor(props: dTaroUi.AtTabsProps) {
    super(props)
    this.state = {
      _scrollLeft: 0,
      _scrollTop: 0,
  ...
  public UNSAFE_componentWillReceiveProps(nextProps: dTaroUi.AtTabsProps): void {
  ...
  public render(): JSX.Element {
    ...
    const tabItems = tabList.map((item, idx) => {
      const itemCls = classNames({
        ...
        'at-tabs__radius_border_right_top': isTabsRadius && current === idx + 1,
        'at-tabs__radius_border_right_bootom': isTabsRadius && current === idx - 1,
      })
