...
export interface AtImagePickerProps {
    /**
     ...
     * default 'aspectFill'
     */
    mode?: 'aspectFill' | 'aspectFit' | 'bottom left' | 'bottom right' | 'bottom' | 'center' | 'left' | 'right' | 'scaleToFill' | 'top left' | 'top right' | 'top' | 'widthFix',
    /**
     * 是否显示添加图片按钮
     * default true
     */
     ...
     * 点击图片触发的回调
     */
    onImageClick?(index: number, file: File, files?: File[]): void,
    /**
